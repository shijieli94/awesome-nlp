...
from .modeling_transfo_xl_utilities import PositionwiseFF, ProjectedAdaptiveLogSoftmax
...
class PositionalEmbedding(nn.Module):
    ...
    def forward(self, pos_seq, bsz=None):
        ...
        return pos_emb[:, None, :].expand(-1, bsz if bsz is not None else 1, -1)
...
class TransfoXLModel(TransfoXLPreTrainedModel):
    def __init__(self, config):
        ...
        if config.attn_type == 0:  # the default attention
            ...
            from .modeling_transfo_xl_utilities import RelLearnableDecoderLayer
            ...
            from .modeling_transfo_xl_utilities import DecoderLayer
