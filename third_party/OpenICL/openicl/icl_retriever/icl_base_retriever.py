...
class BaseRetriever:
        ...
        if isinstance(self.dataset_reader.dataset, Dataset):
            ...
            if self.accelerator is not None:
                self.test_ds = self.test_ds.shard(
                    num_shards=self.accelerator.num_processes, index=self.accelerator.process_index
                )
        else:
    ...
    def get_labels(
        self, ice_template: Optional[PromptTemplate] = None, prompt_template: Optional[PromptTemplate] = None
    ):
        labels = []
