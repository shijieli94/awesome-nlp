...
picked = np.random.randint(len(xs))
MouseEvent("button_press_event", fig.canvas, *ax.transData.transform((xs[picked], ys[picked])), button=1)._process()
KeyEvent("key_press_event", fig.canvas, "n")._process()
