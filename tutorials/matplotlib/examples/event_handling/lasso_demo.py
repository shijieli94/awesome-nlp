...
if __name__ == "__main__":
    ...
    MouseEvent("button_press_event", ax.figure.canvas, *ax.transData.transform((0.5, 0.5)), button=1)._process()

    MouseEvent("motion_notify_event", ax.figure.canvas, *ax.transData.transform((0.8, 0.5)), button=1)._process()
    MouseEvent("motion_notify_event", ax.figure.canvas, *ax.transData.transform((0.8, 0.8)), button=1)._process()
    MouseEvent("motion_notify_event", ax.figure.canvas, *ax.transData.transform((0.5, 0.8)), button=1)._process()
    MouseEvent("motion_notify_event", ax.figure.canvas, *ax.transData.transform((0.5, 0.5)), button=1)._process()

    MouseEvent("button_release_event", ax.figure.canvas, *ax.transData.transform((0.7, 0.7)), button=1)._process()
