...
class MandelbrotDisplay:
    ...
    def ax_update(self, ax):
        ...
        ax.images[-1].set(
            data=self.compute_image(ax.get_xlim(), ax.get_ylim()), extent=(*ax.get_xlim(), *ax.get_ylim())
        )
...
rect = Rectangle([0, 0], 0, 0, facecolor="none", edgecolor="black", linewidth=1.0)
...
ax_zoom.set(xlim=(-2, 0.5), ylim=(-1.25, 1.25))
im = ax_zoom.images[0]
