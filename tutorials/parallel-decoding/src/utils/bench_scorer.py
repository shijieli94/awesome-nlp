from .bleu_calculator import BleuEvaluator, BleuValues


class Scorer(object):
    def __init__(self, name=None, acronym=None):
        self.name = name
    ...
    def compute_bleu_score(self):
        bleu_score = self.bleu_scorer.final_score(model_predictions=self.predictions, gold_references=self.references)
