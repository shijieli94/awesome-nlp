...
from . import modeling_llama as lade_modeling_llama
from .decoding import CONFIG_MAP, FUNC_MAP, greedy_search_proxy, sample_proxy
...
def augment_generate():
    ...
    FUNC_MAP["sample"] = GenerationMixin._sample
